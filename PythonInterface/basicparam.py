...
class ParamExample:
    ...
    def _connected(self, link_uri):
     ...
     # Log Accelerometer
        ...
        self.logAccel.add_variable("pm.vbat", "float")
    ...
    def print_accel_data(self, ident, data, logconfig):
        logging.info("Id={0}, Accelerometer: {1}".format(ident, data))

        # You can also register a callback for a specific group.name combo
        # self._cf.param.add_update_callback(group='deck', name='bcFlow', cb=self._param_callback)
